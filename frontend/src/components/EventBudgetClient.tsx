...
import type { IBudgetItem } from "../lib/models/Event";
...
export default function EventBudgetClient({ eventId, totalBudget, currency, initialItems }: Props) {
  const { addBudgetItem, deleteBudgetItem } = useEvents();
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                ...
                <tr className="bg-slate-50">
                  ...
                  <td className="px-6 py-3 text-right font-bold text-slate-900">{formatAmount(totalSpent, currency)}</td>
                  <td></td>
                </tr>
              </tbody>
            </table>
